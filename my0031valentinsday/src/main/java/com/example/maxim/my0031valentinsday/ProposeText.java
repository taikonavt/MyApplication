 ...
 */
public class ProposeText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.proposetext_activity);

        proposeTV = (TextView) findViewById(R.id.proposeTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.proposeList);

        proposeTV.setText(sms[pos]);
    }
