 ...
 */
public class ChocolateText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chocolatetext_activity);
        ...
        sms = getResources().getStringArray(R.array.chocolateList);

        chocolateTV.setText(sms[pos]);
    }
