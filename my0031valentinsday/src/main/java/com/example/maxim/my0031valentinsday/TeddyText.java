 ...
 */
public class TeddyText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teddytext_activity);

        teddyTV = (TextView) findViewById(R.id.teddyTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.teddyList);

        teddyTV.setText(sms[pos]);
    }
