 ...
 */
public class ValentineText extends AppCompatActivity {

    TextView valentineTV;
    String[] sms;
    int pos;
    String TAG = "myLogs";
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.valentinetext_activity);

        valentineTV = (TextView) findViewById(R.id.valentineTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.valentineList);

        valentineTV.setText(sms[pos]);
    }
