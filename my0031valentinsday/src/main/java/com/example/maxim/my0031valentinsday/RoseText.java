 ...
 */
public class RoseText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rosetext_activity);

        roseTV = (TextView) findViewById(R.id.roseTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.roseList);

        roseTV.setText(sms[pos]);
    }
