 ...
 */
public class PromiseText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.promisetext_activity);

        promiseTV = (TextView) findViewById(R.id.promiseTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.promiseList);

        promiseTV.setText(sms[pos]);
    }
