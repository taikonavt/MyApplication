 ...
 */
public class KissText extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kisstext_activity);

        kissTV = (TextView) findViewById(R.id.kissTV);

        Intent intent = getIntent();

        pos = intent.getIntExtra("pos", 20);

        sms = getResources().getStringArray(R.array.kissList);

        kissTV.setText(sms[pos]);
    }
