package com.example.maxim.p0951servicebackpendingintent;
...
public class MainActivity extends Activity {
    ...
    public void onClickStart(View v) {
        ...
        pi = createPendingResult(TASK1_CODE, getIntent(), 0);
        ...
        pi = createPendingResult(TASK2_CODE, getIntent(), 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK3_CODE, getIntent(), 0);
