package com.example.maxim.p1011contentprovider;
...
public class MyContactsProvider extends ContentProvider {
    ...
    static {
        ...
        // добавляем Uri для сопоставления
        /*
        при подаче на вход uriMatcher.match(uri) AUTHORITY + CONTACT_PATH
         функция возвращает URI_CONTACTS = 1

          при подаче на вход uriMatcher.match(uri) AUTHORITY + CONTACT_PATH + "/#" (число)
         функция возвращает URI_CONTACTS_ID = 2

         AUTHORITY + CONTACT_PATH + "/*" (String)

         AUTHORITY + CONTACT_PATH + "/*" (String) + "/OTHER" (some const) + "/#" (число)
          */
        uriMatcher.addURI(AUTHORITY, CONTACT_PATH, URI_CONTACTS);
        uriMatcher.addURI(AUTHORITY, CONTACT_PATH + "/#", URI_CONTACTS_ID);
        // uriMatcher.addURI(AUTHORITY, CONTACT_PATH + "/*", URI_CONTACTS_STRING);
        // uriMatcher.addURI(AUTHORITY, CONTACT_PATH + "/*/OTHER/#", URI_CONTACTS_SOMETHING);
    }
